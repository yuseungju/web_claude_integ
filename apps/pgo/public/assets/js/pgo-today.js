  ...
  const ROUTE = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'max-particle', label: '맥스 입자 모으기 (걷기)', why: '다이맥스 배틀에 맥스 입자가 든다. 걸어서 모이는 양은 하루 상한이 있어, 안 걸은 날치는 그냥 날아간다.' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'max-battle', label: '다이맥스 배틀 (파워스팟)', why: '모은 맥스 입자를 여기서 쓴다. 이겨야 그 포켓몬을 다이맥스시킬 수 있고, 맥스 먼데이엔 그 주 포켓몬이 정해져 있다.', star: true },
        { id: 'gmax', label: '기가다이맥스 배틀 — 열려 있으면 우선', why: '기가다이맥스는 상시가 아니라 정해진 날에만 열린다. 놓치면 다음 기회까지 한참 걸린다.' },
      ],
    },
    {
